// Code for printing right slanting line of any length using * symbol

#include <iostream>
using namespace std;

// Function to print a right slanting line (diagonal from top-right to bottom-left)
void print(int n)
{
...
int main()
{
    ...
    print(n); // Call the function to print the right slanting line
